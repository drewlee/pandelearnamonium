...
function BinarySearchTree() {
  ...
  this.remove = function (value) {
    ...
    // Only change code below this line
      ...
      function findMinNode(node, minValue = node.value) {
        let minNode = null;
        ...
        if (node.left !== null) {
          minNode = findMinNode(node.left, minValue);
        } else if (node.right !== null) {
          minNode = findMinNode(node.right, minValue);
        }

        if (minNode !== null && minNode.value < minValue) {
          return minNode;
        }
      ...
      if (target === this.root) {
        const minNode = findMinNode(target.right);
